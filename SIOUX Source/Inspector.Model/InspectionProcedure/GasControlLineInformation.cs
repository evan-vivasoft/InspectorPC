...
namespace Inspector.Model.InspectionProcedure
{
    ...
    public class GasControlLineInformation
    {
        ...
        /// </summary>
        internal GasControlLineInformation(Guid id, string gclName, string peMin, string peMax, string volumeVa, string volumeVak,
                                         string paRangeDM, string peRangeDM, string gclIdentification, string gclCode, int fsdStart,
                                         string inspectionProcedure, InspectionStatus inspectionStatus, Guid? inspectionProcedureId = null, int? startPosition = null)
        {
            Id = id;
