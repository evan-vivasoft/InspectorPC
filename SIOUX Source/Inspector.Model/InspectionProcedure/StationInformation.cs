...
namespace Inspector.Model.InspectionProcedure
{
    ...
    public class StationInformation
    {
        ...
        /// </summary>
        internal StationInformation(string route, string prsCode, string prsName, string prsIdentification, string information, string inspectionProcedure, InspectionStatus inspectionStatus, Guid inspectionProcedureId, Guid id)
        {
