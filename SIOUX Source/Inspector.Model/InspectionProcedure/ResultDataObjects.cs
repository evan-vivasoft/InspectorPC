...
namespace Inspector.Model.InspectionProcedure
{
    ...
    public struct InspectionProcedureGenericInformation
    {
        ...
        public Guid InspectionProcedureId;
        ...
        public InspectionProcedureGenericInformation(InspectionStatus status, string prsIdentification, string prsName, string prsCode, string gclName, string gclIdentification, string gclCode, string crc, string inspectionProcedureName, string inspectionProcedureVersion, Guid inspectionProcedureId, Guid prsId, Guid gclId, int? startPosition = null, Guid? chainId = null)
        {
    ...
    public struct InspectionProcedureStepResult
    {
        ...
        public InspectionProcedureStepResult(long sequenceNumber, string measurePoint, DateTime executed, int? fieldNo = null)
        {
        ...
        public InspectionProcedureStepResult(Guid linkId, long sequenceNumber, string measurePoint, DateTime executed, int? fieldNo, string objectName, string objectId, string measurePointId, string text, string objectNameDescription, string measurePointDescription, List<string> options = null, InspectionProcedureStepResultMeasureValue? measureValue = null, Guid? scriptCommandId = null, double? offset = null, double? maximumValue = null, double? minimumValue = null, UnitOfMeasurement? uom = null)
        {
            LinkId = linkId;
            SequenceNumber = sequenceNumber;
            FieldNumber = fieldNo;
