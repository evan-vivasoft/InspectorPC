...
namespace Inspector.BusinessLogic.Data.Reporting.Results.Model
{
    ...
    public class Result
    {
        ...
        public Result(Guid linkId, long sequenceNumber, string objectName, string objectId, string measurePoint, string measurePointId, int? fieldNo, TimeSpan time, MeasureValue measureValue, string text, List<string> list, string objectNameDescription, string measurePointDescription, Guid? scId = null, double? maxValue = null, double? minValue = null, double? offset = null, UnitOfMeasurement? uom = null)
