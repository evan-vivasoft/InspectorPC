...
namespace Inspector.BusinessLogic
{
    ...
    public class InspectionActivityControl : IInspectionActivityControl
    {
        ...
        /// <summary>
        /// Executes the partial inspection. Gets called when user presses `Start Inspection` button
        /// </summary>
        ...
        private void PrepareRequiredManometers()
        {
            ...
            if (m_RequiredManometers.Count > 0 && m_InspectionResult == InspectionProcedureResult.SUCCESS)
            {
                ...
                var maybePRS = StationInformationManager.LookupStationInformation(m_PrsName);
                var maybeGCL = StationInformationManager.LookupGasControlLineInformation(m_PrsName, m_GclName);

                if (maybeGCL != null && maybePRS != null && m_MeasurementFileCreationEnabled)
                {
                    MeasurementReportControl.InitializeMeasurementReport(m_PrsName, maybePRS.Id, m_GclName, maybeGCL.Id, m_InspectionStartTimestamp);
                }

                // Below line is commented by me. Check its effect
                //if (m_MeasurementFileCreationEnabled)
                //{
        ...
        /// <summary>
        /// Setups the inspection report. This function fetches StationInfo, GCL Info and sets up InspectionProcedure accordingly
        /// </summary>
        /// <param name="ChainId"> A guid that will be used to map measurement report and Result report </param>
        ...
        private void SetupInspectionReport()
        {
            ...
            try
            {
                var inspectionProcedure = new InspectionProcedureGenericInformation
                {
                    ...
                    InspectionProcedureId = stationInfo.InspectionProcedureId ?? Guid.Empty
                };
                ...
                if (!string.IsNullOrEmpty(m_GclName))
                {
                    ...
                    inspectionProcedure.GCLId = gclInfo.Id;
                    inspectionProcedure.InspectionProcedureId = gclInfo.InspectionProcedureId ?? Guid.Empty;
                }
        ...
        private void StoreResultsOfScriptCommand5X()
        {
            try
            {
                ...
                var scriptCommandBoundary = scriptCommand5X.StationStepObject.Boundaries;

                var inspectionResult = new InspectionProcedureStepResult(scriptCommand5X.LinkId, scriptCommand5X.SequenceNumber, scriptCommand5X.StationStepObject.MeasurePoint, m_MeasurementEndDate.Value, scriptCommand5X.StationStepObject.FieldNo, scriptCommand5X.StationStepObject.ObjectName, scriptCommand5X.StationStepObject.ObjectID, scriptCommand5X.StationStepObject.MeasurePointID, string.Empty, scriptCommand5X.ObjectNameDescription, scriptCommand5X.MeasurePointDescription, null, measureValue, scriptCommandBoundary.ScriptCommandId, scriptCommandBoundary.Offset, scriptCommandBoundary.ValueMax, scriptCommandBoundary.ValueMin, scriptCommandBoundary.UOV);
        ...
        private void StoreResultsOfScriptCommand42(object stepResult)
        {
            try
            {
                ...
                var inspectionResult = new InspectionProcedureStepResult(scriptCommand42.LinkId, stepResultEmpty.SequenceNumber, scriptCommand42.StationStepObject.MeasurePoint, DateTime.Now, scriptCommand42.StationStepObject.FieldNo, scriptCommand42.StationStepObject.ObjectName, scriptCommand42.StationStepObject.ObjectID, scriptCommand42.StationStepObject.MeasurePointID, String.Empty, scriptCommand42.ObjectNameDescription, scriptCommand42.MeasurePointDescription);
        ...
        private void StoreResultsOfScriptCommand41(object stepResult)
        {
            try
            {
                ...
                var inspectionResult = new InspectionProcedureStepResult(scriptCommand41.LinkId, stepResultSelections.SequenceNumber, scriptCommand41.StationStepObject.MeasurePoint, DateTime.Now, scriptCommand41.StationStepObject.FieldNo, scriptCommand41.StationStepObject.ObjectName, scriptCommand41.StationStepObject.ObjectID, scriptCommand41.StationStepObject.MeasurePointID, stepResultSelections.Remark, scriptCommand41.ObjectNameDescription, scriptCommand41.MeasurePointDescription, stepResultSelections.ListSelections);
        ...
        private void StoreResultsOfScriptCommand4(object stepResult)
        {
            try
            {
                ...
                var inspectionResult = new InspectionProcedureStepResult(scriptCommand4.LinkId, stepResultText.SequenceNumber, scriptCommand4.StationStepObject.MeasurePoint, DateTime.Now, scriptCommand4.StationStepObject.FieldNo, scriptCommand4.StationStepObject.ObjectName, scriptCommand4.StationStepObject.ObjectID, scriptCommand4.StationStepObject.MeasurePointID, stepResultText.Text, scriptCommand4.ObjectNameDescription, scriptCommand4.MeasurePointDescription);
                ReportControl.AddResult(inspectionResult);
            }
            catch (InspectorReportControlException)
            {
        ...
        private void HandleContinuousMeasurement(ScriptCommand5X scriptCommand5X)
        {
            ...
            try
            {
                MeasurementReportControl.StartMeasurement(m_MeasurementUnit, m_MeasurementStartDate, m_Initialization.GetStoreIOStatus(), scriptCommand5X.LinkId, (double) scriptCommand5X.MeasurementFrequency, 1.0 / (double) scriptCommand5X.MeasurementFrequency);
            }
                ...
                try
                {
                    ...
                    else
                    {
                        ...
                        if (m_IsScriptCommand70Enabled)
                        {
                            ...
                            if (m_MeasurementFileCreationEnabled)
                            {
                                MeasurementReportControl.StartMeasurement(m_MeasurementUnit, m_MeasurementStartDate, storeIOStatus, scriptCommand5X.LinkId, (double) scriptCommand5X.MeasurementFrequency, 1.0 / (double) scriptCommand5X.MeasurementFrequency);
                            }
                        }
                        else
                        {
