...
namespace OpenNETCF.Desktop.Communication
{
    ...
    public delegate void FileCopyProcess(Int64 totalBytes, Int64 bytesProcessed, string fileName);
    ...
    public class RAPI : IRAPI
    {
        ...
        public event FileCopyProcess FileCopyProcessStatus;
        ...
        public void CopyFileFromDevice(string LocalFileName, string RemoteFileName, bool Overwrite)
        {
            ...
            int filepos = 0;
            Int64 totalByteSize = GetDeviceFileSize(RemoteFileName);
            FileCopyProcessStatus(totalByteSize, 0, RemoteFileName);
            ...
            while (bytesread > 0) {
                ...
                filepos += bytesread;
                FileCopyProcessStatus(totalByteSize, filepos, RemoteFileName);
        ...
        public void CopyFileToDevice(string LocalFileName, string RemoteFileName, bool Overwrite)
        {
            ...
            Int64 totalByteSize = localFile.Length;
            FileCopyProcessStatus(totalByteSize, 0, LocalFileName);
            ...
            while (bytesread > 0) {
                ...
                filepos += bytesread;
                FileCopyProcessStatus(totalByteSize, filepos, LocalFileName);
