    ...
    Private Sub setColumnsPRSGrid()
        Try
            With Me.rdGridPRSData.MasterTemplate
                ...
                .Columns(PRSDataFields.FldPRSRoute).IsVisible = True 'MOD 108
                ...
                .Columns("InspectionProcedureId").IsVisible = False
                ...
                .Templates(0).Columns("InspectionProcedureId").IsVisible = False
                .Templates(0).Columns("StartPosition").IsVisible = False
                .Templates(0).Columns("Id").IsVisible = False
