...
#Region "GUI Handling"
    ...
    Private Sub StartSync()
        ...
        'MOD XXa
        'Check Android attachment

        'If ModAndroidDevice.ConnectStatus = True Then InspectorSyncHandling.StartSynchronisation()
        'MOD XXa 'Also possible to attache Android sync
        If InspectorSyncHandling.InspectorPcInstalled = True Then InspectorSyncHandling.StartSynchronisation()

        'MOD XXa check connection with android device
