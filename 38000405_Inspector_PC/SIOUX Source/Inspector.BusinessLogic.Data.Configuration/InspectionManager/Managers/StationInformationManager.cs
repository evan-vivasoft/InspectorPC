    ...
    public class StationInformationManager : IStationInformationManager
    {
        ...
        private void LoadStationsInformation()
        {
            ...
            foreach (var prs in stationsInfoLoader.PRSEntities)
            {
                ...
                var stationInfo = new StationInformation(prs.Route, prs.PRSCode, prs.PRSName, prs.PRSIdentification, prs.Information, prs.InspectionProcedure, inspectionStatus);
