    ...
    public class InspectionInformationManager : IInspectionInformationManager
    {
        ...
        private StationStepObject LookUpStationStepObject(ScriptCommandEntityBase scriptCommandEntity, string prsName, string gclName)
        {
            ...
            try
            {
                ...
                stationStepObject = isPRSInspection ? CreateStationStepObject(stationStepIdentifier, prsName, isLookUpOnFieldNo, isLookUpOnObjectNameAndMeasurepoint) : CreateStationStepObject(stationStepIdentifier, prsName, gclName, isLookUpOnFieldNo, isLookUpOnObjectNameAndMeasurepoint);
            }
            catch (InvalidOperationException exception)
            {
