...
#Region "Event handling of Inspection Step Handling"
    ...
    Private Sub InspectionActivityControl_ExecuteInspectionStep(ByVal sender As Object, ByVal e As EventArgs)
        ...
        BeginInvoke(New Action(Of InspectionProcedure.ScriptCommandBase, Integer, Integer)(AddressOf ExecuteInspectionCommand), stepEventArgs.ScriptCommand, stepEventArgs.CurrentInspectionStep, stepEventArgs.TotalInspectionSteps)
    End Sub
    ''' <summary>
