...
#Region "Main Thread"
    ...
    Private Sub SyncThreadTask()
            ...
            If stepExecute = True Then
                Select Case synchronisationStepToExecute.ToString
                    ...
                    Case SynchronisationStep.Getting_Paths_From_Database.ToString
                        ...
                        RaiseEventStatusStarted(synchronisationStepToExecute, syncStatusInfo)
                        GetCommunicatorPaths(deviceSyncHandling.InspectionInformation.SerialNumber)
        ...
        If Inspectortype = enumInspectorType.InspectorPc And m_InspectorPdaInstalled = True Then AddHandler IpPDASyncHandling.EvntRapiConnected, AddressOf EvntConnection
        Exit Sub
    End Sub
