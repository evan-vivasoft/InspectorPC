...
namespace Inspector.BusinessLogic.Data.Reporting.Test
{
    ...
    public class ReportControlTest
    {
        ...
        public void ReportControlHappyFlowTest()
        {
            ...
            reportControl.AddResult(new InspectionProcedureStepResult(2, m_MeasurePoint2, m_Testtime2, m_FieldNo2, m_ObjectName, m_ObjectId, m_MeasurePointId, m_TextwithInvalidChars, m_Lists, measureValue));
            ...
            reportControl.AddResult(new InspectionProcedureStepResult(3, m_MeasurePoint2, m_Testtime2, m_FieldNo2, m_ObjectName, m_ObjectId, m_MeasurePointId, m_TextwithInvalidChars, m_Lists, measureValue));
            ...
            reportControl.AddResult(new InspectionProcedureStepResult(4, m_MeasurePoint2, m_Testtime2, m_FieldNo2, m_ObjectName, m_ObjectId, m_MeasurePointId, m_TextwithInvalidChars, m_Lists, measureValue));
            ...
            reportControl.AddResult(new InspectionProcedureStepResult(5, m_MeasurePoint2, m_Testtime2, m_FieldNo2, m_ObjectName, m_ObjectId, m_MeasurePointId, m_TextwithInvalidChars, m_Lists, measureValue));
            ...
            reportControl.AddResult(new InspectionProcedureStepResult(6, m_MeasurePoint2, m_Testtime2, m_FieldNo2, m_ObjectName, m_ObjectId, m_MeasurePointId, m_TextEmpty));
        ...
        public void ReportControlDuplicateResultTest()
        {
            ...
            InspectionProcedureStepResultMeasureValue measureValue = new InspectionProcedureStepResultMeasureValue(m_MeasureValue, m_UnitOfMeasureMentDm3h);
            reportControl.AddResult(new InspectionProcedureStepResult(2, m_MeasurePoint, m_Testtime1, m_FieldNo1, m_ObjectName, m_ObjectId, m_MeasurePointId, m_TextwithInvalidChars, m_Lists, measureValue));
