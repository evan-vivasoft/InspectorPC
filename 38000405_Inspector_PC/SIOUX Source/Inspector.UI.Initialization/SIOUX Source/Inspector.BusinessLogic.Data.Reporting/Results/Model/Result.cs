...
namespace Inspector.BusinessLogic.Data.Reporting.Results.Model
{
    ...
    public class Result
    {
        ...
        public Result(long sequenceNumber, string objectName, string objectId, string measurePoint, string measurePointId, int? fieldNo, TimeSpan time, MeasureValue measureValue, string text, List<string> list)
