...
namespace Inspector.Model.InspectionProcedure
{
    ...
    public class GclObject : PrsGclObjectBase
    {
        ...
        internal GclObject(string objectName, string objectNameDescription, string objectId, string measurePoint, string measurePointDescription, string measurePointId, int? fieldNo, GclBoundaries gclBoundary)
        {
