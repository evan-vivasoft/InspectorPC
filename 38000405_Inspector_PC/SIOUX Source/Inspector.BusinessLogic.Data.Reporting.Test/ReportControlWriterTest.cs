...
namespace Inspector.BusinessLogic.Data.Reporting.Test
{
    public class ReportControlWriterTest
    {
        ...
        Result m_ResultMaximum = new Result(1, "ObjectNameMAX", "ObjectIdMAX", "msrPointMAX", "msrPointIdMAX", 1, new TimeSpan(12, 5, 30), new MeasureValue(0.0002, UnitOfMeasurement.ItemDm3h), "Text Example MAX", m_Listexample, string.Empty,string.Empty);
        ...
        public void Setup()
        {
            var path = Path.GetDirectoryName(typeof(ReportControlWriterTest).Assembly.Location);
        ...
        public void DeSerializeTest()
        {
            ...
            reportControlDesrializer.InspectionReport = InspectionReportsData.ReadResultFile(m_XmlTargetFileName);
