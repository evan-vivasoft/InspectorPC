...
namespace Inspector.Connection
{
    ...
    public partial class ConnectionStateMachine : IConnectionStateMachine
    {
        ...
        public IList<Measurement> MeasurementData { get; set; }
        ...
        public void Do_UnpairDevices(string address)
        {
            Hal.UnPairDevices(address);
        }

        public void Do_DeviceUnPaired(string address)
        {
            OnDeviceUnPaired(address);
        }

        public void Do_DeviceUnPairFinished()
        {
        ...
        public void OnMeasurementReceived(IList<Measurement> measurements)
        {
        ...
        public void OnDeviceUnPaired(string address)
        {
            if(DeviceUnPaired != null)
            {
                DeviceUnPaired(this, new DeviceUnPairedEventArgs(address));
            }
        }

        public void OnDeviceUnPairFinished()
        {
