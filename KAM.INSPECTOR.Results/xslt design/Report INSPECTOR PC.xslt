...
<xsl:stylesheet version="2.0" xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:altova="http://www.altova.com" xmlns:altovaext="http://www.altova.com/xslt-extensions" xmlns:clitype="clitype" xmlns:fn="http://www.w3.org/2005/xpath-functions" xmlns:iso4217="http://www.xbrl.org/2003/iso4217" xmlns:ix="http://www.xbrl.org/2008/inlineXBRL" xmlns:java="java" xmlns:link="http://www.xbrl.org/2003/linkbase" xmlns:msdata="urn:schemas-microsoft-com:xml-msdata" xmlns:sps="http://www.altova.com/StyleVision/user-xpath-functions" xmlns:xbrldi="http://xbrl.org/2006/xbrldi" xmlns:xbrli="http://www.xbrl.org/2003/instance" xmlns:xlink="http://www.w3.org/1999/xlink" xmlns:xs="http://www.w3.org/2001/XMLSchema" xmlns:xsd="http://www.w3.org/2001/XMLSchema" xmlns:xsi="http://www.w3.org/2001/XMLSchema-instance" exclude-result-prefixes="#all">
	...
	<xsl:param name="SV_GeneratedFileNamePrefix" select="if ( $SV_BaseOutputFileName ) then $SV_BaseOutputFileName else &apos;Report INSPECTOR PC&apos;" as="xs:string?"/>
	<xsl:variable name="XML" select="/"/>
	<xsl:variable name="altova:nPxPerIn" select="96"/>
	<xsl:import-schema schema-location="M:\Projecten\plexor\992\992C CONNEXION II\XML\InspectionResultsData.xsd"/>
			...
			<body>
				<img style="height:106px; ">
					<xsl:attribute name="src">
						<xsl:if test="substring(string(&apos;M:\bibliotheek\Icons\JPG Kamstrup\Kamstrup logo.jpg&apos;), 2, 1) = ':'">
							<xsl:text>file:///</xsl:text>
						</xsl:if>
						<xsl:value-of select="translate(string(&apos;M:\bibliotheek\Icons\JPG Kamstrup\Kamstrup logo.jpg&apos;), '&#x5c;', '/')"/>
					</xsl:attribute>
								...
								<table border="1" width="100%">
									...
									<tbody>
										...
										<tr>
											<td style="width:114px; ">
												<span style="font-weight:bold; ">
													<xsl:text>Inspectieprocedure:</xsl:text>
												</span>
											</td>
											<td>
								...
								<table border="1">
									...
									<tbody>
										...
										<tr>
											<td align="left">
												<span>
													<xsl:text>Meetapparatuur:</xsl:text>
												</span>
											</td>
											<td>
								...
								<table border="1">
									...
									<thead>
										<tr>
											...
											<th>
												<xsl:if test="exists(  Result/FieldNo  )">
													<span>
											...
											<th>
												<xsl:if test="exists(  Result/ObjectName  )">
													<span>
														<xsl:text>Objectnaam</xsl:text>
													</span>
												</xsl:if>
											</th>
											<th>
												<xsl:if test="exists(  Result/MeasurePoint  )">
													<span>
														<xsl:text>Meetpunt</xsl:text>
													</span>
												</xsl:if>
											</th>
											<th style="width:136px; ">
												<xsl:if test="exists(  Result/MeasureValue  )">
													<span>
														<xsl:text>Meetwaarde</xsl:text>
													</span>
												</xsl:if>
											</th>
											<th>
												<xsl:if test="exists(  Result/Text  )">
													<span>
											...
											<th>
												<xsl:if test="exists(  Result/List  )">
													<span>
